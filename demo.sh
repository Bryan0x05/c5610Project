...
tmux split-window -h -t $TMUX_SESSION_NAME
tmux send-keys -t $TMUX_SESSION_NAME:1.0 "python3 "$TARGET_SCRIPT " " $ARG1 " " $ARG2 Enter
tmux send-keys -t $TMUX_SESSION_NAME:1.1 "python3 "$TARGET_SCRIPT " " $ARG1 " " $ARG2 Enter
tmux send-keys -t $TMUX_SESSION_NAME:1.2 "python3 "$TARGET_SCRIPT " " $ARG1 " " $ARG2 Enter
